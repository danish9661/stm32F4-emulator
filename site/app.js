...
import * as bindings from './vendor/stm32_periph_wasm.js?v=32';
...
import { FIRMWARES } from './firmware.js?v=24';
...
const boot = async () => {
    ...
    if (bridgeUrl) {
        ...
        // NOTE (VENDOR_V): vendor asset versions (?v=32) must be bumped together
        ...
        const svdXml = await fetch('vendor/' + board.svd + '?v=32').then((r) => r.text());
        ...
        emu = await createEmulator({
            ...
            wasmUrl: 'vendor/stm32_periph_wasm_bg.wasm?v=32',
