...
const boot = async () => {
    ...
    if (bridgeUrl) {
        ...
        // NOTE (VENDOR_V): vendor asset versions (?v=29) must be bumped together
        ...
        const svdXml = await fetch('vendor/' + board.svd + '?v=29').then((r) => r.text());
        ...
        emu = await createEmulator({
            ...
            wasmUrl: 'vendor/stm32_periph_wasm_bg.wasm?v=29',
