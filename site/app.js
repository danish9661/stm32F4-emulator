...
import * as bindings from './vendor/stm32_periph_wasm.js?v=23';
...
import { FIRMWARES } from './firmware.js?v=21';
...
const boot = async () => {
    ...
    if (bridgeUrl) {
        ...
        // NOTE (VENDOR_V): vendor asset versions (?v=23) must be bumped together
        ...
        const svdXml = await fetch('vendor/' + board.svd + '?v=23').then((r) => r.text());
        ...
        emu = await createEmulator({
            ...
            wasmUrl: 'vendor/stm32_periph_wasm_bg.wasm?v=23',
