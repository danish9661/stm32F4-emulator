...
import * as bindings from './vendor/stm32_periph_wasm.js?v=33';
...
const boot = async () => {
    ...
    if (bridgeUrl) {
        ...
        // NOTE (VENDOR_V): vendor asset versions (?v=33) must be bumped together
        ...
        const svdXml = await fetch('vendor/' + board.svd + '?v=33').then((r) => r.text());
        ...
        emu = await createEmulator({
            ...
            wasmUrl: 'vendor/stm32_periph_wasm_bg.wasm?v=33',
