...
import * as bindings from './vendor/stm32_periph_wasm.js?v=37';
...
const boot = async () => {
    ...
    if (bridgeUrl) {
        ...
        // NOTE (VENDOR_V): vendor asset versions (?v=37) must be bumped together
        ...
        const svdXml = await fetch('vendor/' + board.svd + '?v=37').then((r) => r.text());
        ...
        emu = await createEmulator({
            ...
            wasmUrl: 'vendor/stm32_periph_wasm_bg.wasm?v=37',
