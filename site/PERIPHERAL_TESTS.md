...
Plus the Rust unit suite: `cargo test` (126 tests — CPU/decoder incl. FPU
encoding/semantics/stacking tests and 27 interrupt/system-fidelity tests
...
LTDC, register files — 126/126 green).
