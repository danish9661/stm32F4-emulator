...
bare('standby_demo', ALL3, ['WOKE FROM STANDBY'], null, { lowpower: true });
...
bare('gap10_sdio', ALL3, ['SDIO GAP10 OK'], ['FAIL'], { ext_devices: { sdio: { blocks: 4 } } });
bare('gap10_qspi', ALL3, ['QSPI GAP10 OK'], ['FAIL'], { ext_devices: DEV.qspi });
bare('gap10_ltdc', ['f429'], ['LTDC GAP10 OK'], ['FAIL']);
bare('gap10_ltdc', ['f401', 'f411'], ['LTDC GAP10 OK'], ['FAIL'], { expectFail: 'no-LTDC-silicon' });
bare('gap10_i2c', ALL3, ['I2C GAP10 ARMED'], ['FAIL']);
bare('gap10_dma', ALL3, ['DMA GAP10 OK'], ['FAIL']);
