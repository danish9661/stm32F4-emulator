...
| DCMI | 81 | Partial | CR/SR/RIS/IER/ICR/ESCR/ESUR/CWSTRT/CWSIZ/DR; consumes a JS-fed camera frame with VSYNC/LINE/FRAME/OVR semantics and a 4-deep FIFO. Source: `ext_devices.camera` (pumped every step) or `emu.camera.feed(w,h,pixels)` | Y (78) | N | N |
