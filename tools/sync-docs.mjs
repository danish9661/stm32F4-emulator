...
const DOCS = [
    ...
    ['docs/boards/stm32f401.md', 'boards/stm32f401.md', 'Board: STM32F401', '37 presets, no CAN/ETH, BlackPill + Nucleo'],
    ['docs/boards/stm32f411.md', 'boards/stm32f411.md', 'Board: STM32F411', '37 presets, F401 + SPI5'],
    ['docs/boards/stm32f407.md', 'boards/stm32f407.md', 'Board: STM32F407', 'Reference target, 72 presets, feature matrix'],
    ['docs/boards/stm32f407ve.md', 'boards/stm32f407ve.md', 'Board: F407VE/ZE', '512K package, 73 presets'],
    ['docs/boards/stm32f429.md', 'boards/stm32f429.md', 'Board: STM32F429', 'DMA2D/LTDC/Ethernet proofs, 59 presets'],
