...
impl Stream {
    ...
    // PSIZE=bits 9:8, MSIZE=bits 11:10; use min of both.
    // reserved patterns (0b11) decode as 32-bit on silicon.
    ...
    fn word_size(&self) -> usize {
        // MSIZE=bits 11:10, PSIZE=bits 9:8
    ...
    fn do_xfer(&self, name: &str, sys: &System) {
        ...
        trace!("{} xfer src=0x{:08x} dst=0x{:08x} size={} buf={:x?}", name, src, dst, size, buf);
