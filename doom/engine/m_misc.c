...
boolean M_FileExists(char *filename)
{
    ...
    // Bare-metal F407 port: the WAD "file" lives in guest memory
    // (doomplatform.h); check it before falling back to fopen.
    if (doom_file_exists(filename))
    {
        return true;
    }
