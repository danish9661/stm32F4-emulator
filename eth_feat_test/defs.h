...
#define PTPSSIR (*(volatile unsigned int *)(ETH_PTP_BASE + 0x04))
...
#define PTPTSAR (*(volatile unsigned int *)(ETH_PTP_BASE + 0x18))
#define PTPTTHR (*(volatile unsigned int *)(ETH_PTP_BASE + 0x1C))
#define PTPTTLR (*(volatile unsigned int *)(ETH_PTP_BASE + 0x20))
#define PTPPPSCR (*(volatile unsigned int *)(ETH_PTP_BASE + 0x2C))
